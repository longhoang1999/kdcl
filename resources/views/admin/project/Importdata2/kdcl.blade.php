...
{{-- Page title --}}
@section('title')
    @lang('project/ImportdataExcel/title.kdcl')
@parent
@stop
...
<section class="content-body">
    <div class="form-standard">
        <div class="item-group-button right-block mb-2">
            ...
            <a href="{{ route('admin.importdata.kdcl.exportKdcl') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Selfassessment/title.xuat_excel')">
                <i class="bi bi-file-earmark-excel " style="font-size: 35px;color: #50cd89;"></i>
            </a>
            <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="excel_import_kdcl" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <table class="table table-striped table-bordered" id="table" width="100%">
            <thead>
             <tr>
                ...
                <th>
                    @lang('project/ImportdataExcel/title.btcdg')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.namht')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.namcn')
                </th>
                <th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    @lang('project/ImportdataExcel/title.cnkdcl')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.importdata.kdcl.updateUnit') }}" method="post" id="update-unit">
                    @csrf
                    ...
                    <div class="container-fuild">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="forbtcdg">
                                    <span>@lang('project/ImportdataExcel/title.btcdg')</span>
                                </label>
                                <input type="text" class="form-control " id="forbtcdg" placeholder="@lang('project/ImportdataExcel/title.btcdg')" name="btcdg ">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fornamht">
                                    <span>@lang('project/ImportdataExcel/title.namht')</span>
                                </label>
                                <input type="number" class="form-control " id="fornamht" placeholder="@lang('project/ImportdataExcel/title.namht')" name="namht">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fornamcn">
                                    <span>@lang('project/ImportdataExcel/title.namcn')</span>
                                </label>
                                <input type="number" class="form-control " id="fornamcn" placeholder="@lang('project/ImportdataExcel/title.namcn')" name="namcn">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forttcdg">
                                    <span>@lang('project/ImportdataExcel/title.ttcdg')</span>
                                </label>
                                <input type="text" class="form-control " id="forttcdg" placeholder="@lang('project/ImportdataExcel/title.ttcdg')" name="ttcdg">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forndgn">
                                    <span>@lang('project/ImportdataExcel/title.ndgn')</span>
                                </label>
                                <input type="text" class="form-control " id="forndgn" placeholder="@lang('project/ImportdataExcel/title.ndgn')" name="ndgn">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forkqhd">
                                    <span>@lang('project/ImportdataExcel/title.kqhd')</span>
                                </label>
                                <input type="text" class="form-control " id="forkqhd" placeholder="@lang('project/ImportdataExcel/title.kqhd')" name="kqhd">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forngaycap">
                                    <span>@lang('project/ImportdataExcel/title.ngaycap')</span>
                                </label>
                                <input type="text" class="form-control " id="forngaycap" placeholder="@lang('project/ImportdataExcel/title.ngaycap')" name="ngaycap">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forgtd">
                                    <span>@lang('project/ImportdataExcel/title.gtd')</span>
                                </label>
                                <input type="text" class="form-control " id="forgtd" placeholder="@lang('project/ImportdataExcel/title.gtd')" name="gtd ">
                            </div>
                        </div>
...
<script>
    ...
    $('#import_unit').on('click', function () {
        ...
        $.ajax({
            url : "{!! route('admin.importdata.kdcl.importUnit') !!}",
            type : 'POST',
            data : formData,
            processData: false,  
            contentType: false,  
                        ...
                        <thead class="btn-success ">
                            <tr class="border ">
                                ...
                                <th class="row_width p-2" colspan="2">
                                    @lang('project/ImportdataExcel/title.tudanhgia')                                  
                                </th>
                                <th class="row_width p-2" colspan="2">
                                    @lang('project/ImportdataExcel/title.dgn')                                  
                                </th>
                                <th class="row_width p-2" colspan="3">
                                    @lang('project/ImportdataExcel/title.tdvcn')                                  
                                </th>
                            ...
                            <tr class="border ">
                                ...
                                <th class="row_width p-2" rowspan="2">
                                    @lang('project/ImportdataExcel/title.ttcdg')
                                </th>
                                <th class="row_width p-2" rowspan="2">
                                    @lang('project/ImportdataExcel/title.ndgn')
                                </th>
                                <th class="row_width p-2" rowspan="2">
                                    @lang('project/ImportdataExcel/title.kqhd')
                                </th>
                                <th class="row_width p-2" colspan="2">
                                    @lang('project/ImportdataExcel/title.gcn')
                                </th>
                            </tr>
                            <tr class="border ">
                                <th class="row_width p-2" >
                                    @lang('project/ImportdataExcel/title.ngaycap')
                                </th>
                                <th class="row_width p-2" >
                                    @lang('project/ImportdataExcel/title.gtd')
                                </th>
                            </tr>  
                        </thead>
    ...
    $("#import_unit_data").click(function() {
        if(checkEmpty() && checkWebsite() && checkEmail() && checkPhone()
            ...
            $(".row_number").each(function( index ) {
                let dataObj = {
                    'doituong' :   $(this).find('.row1').text().trim(),
                    'btcdg' :  $(this).find('.row2').text().trim(),
                    'namht' : $(this).find('.row3').text().trim(),
                    'namcn' : $(this).find('.row4').text().trim(),
                    'ttcdg' :  $(this).find('.row5').text().trim(),
                    'ndgn' :  $(this).find('.row6').text().trim(),
                    'kqhd' : $(this).find('.row7').text().trim(),
                    'ngaycap' : $(this).find('.row8').text().trim(),
                    'gtd' : $(this).find('.row9').text().trim(),
                    
                }
                dataSubmit.push(dataObj);
            });

            let loadData = "{{ route('admin.importdata.kdcl.importDataUnit') }}";
            fetch(loadData, {
                headers: {
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "{{ route('admin.importdata.kdcl.deleteUnit') }}" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id') 
        $("#id_unit").val(id);
        let loadData = "{{ route('admin.importdata.kdcl.dataUnit') }}" + "?id=" + id;
        fetch(loadData, {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then((response) => response.json())
            .then((data) => {
                $("#fordoituong").val(data.doi_tuong);
                $("#forbtcdg").val(data.btcdg);
                $("#fornamht").val(data.nhtbcttdg1);
                $("#fornamcn").val(data.ncnbctdg);
                $("#forttcdg").val(data.ten_tcdg);
                $("#forndgn").val(data.thang_nam_dgn);
                $("#forkqhd").val(data.kqdgchd);
                $("#forngaycap").val(data.gcn_ngay_cap);
                $("#forgtd").val(data.gcn_gia_tri_den);
