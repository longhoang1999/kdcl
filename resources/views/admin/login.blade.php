                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('signin') }}" autocomplete="on" method="post" id="login_form" class="my-3">
                                <h3 class="black_bg">
                                    <img src="{{ asset('img/logo.png') }}" alt="josh logo">
                                    <br>
                                    @lang('project/Common/title.login')
                                </h3>
                                <!-- CSRF Token -->
                                ...
                                <div class="form-group">
                                    <label style="margin-bottom:0px;" for="email" class="uname control-label"> <i
                                        ...
                                        @lang('project/Common/title.tdn')
                                    </label>
                                    <input name="email" type="text" placeholder="@lang('project/Common/title.tdn')"
                                ...
                                <div class="form-group">
                                    <label style="margin-bottom:0px;" for="password" class="youpasswd"> <i
                                            ...
                                            data-c="#3c8dbc" data-hc="#3c8dbc"></i>
                                        @lang('project/Common/title.password')
                                    </label>
                                    <input id="password" name="password" type="password"
                                        placeholder="@lang('project/Common/title.password')" required />
                                </div>
                                <div class="form-group">
                                    <label>
                                ...
                                <p class="login button">
                                    <input type="submit" value="@lang('project/Common/title.btn_login')" class="btn btn-success btn-block" />
                                </p>
                                <!-- <p class="change_link">
                                    <a href="#toforgot">
