...
{{-- Page title --}}
@section('title')
    @lang('project/ImportdataExcel/title.dtkhcn')
@parent
@stop
...
<section class="content-body">
    <div class="form-standard">
        <div class="item-group-button right-block mb-2">
            ...
            <a href="{{ route('admin.importdata.dtkhcn.exportUnit') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xuat_excel')">
                <i class="bi bi-file-earmark-excel " style="font-size: 35px;color: #50cd89;"></i>
            </a>
            <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="export_import_dtkhcn" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <table class="table table-striped table-bordered" id="table" width="100%">
            <thead>
             <tr>
                ...
                <th>
                    @lang('project/ImportdataExcel/title.tenhd')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.dvtn')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.namcg')
                </th>
                <th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUnitLabel">
                    @lang('project/ImportdataExcel/title.ttdnkhcn')
                </h5>
...
<div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="modalUpdateLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.importdata.dtkhcn.updateUnit') }}" method="post" id="update-unit">
                    @csrf
                    ...
                    <div class="container-fuild">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="fortenhd">
                                    <span>@lang('project/ImportdataExcel/title.tenhd')</span>
                                </label>
                                <input type="text" class="form-control " id="fortenhd" placeholder="@lang('project/ImportdataExcel/title.tenhd')" name="tenhd">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="formahd">
                                    <span>@lang('project/ImportdataExcel/title.mahd')</span>
                                </label>
                                <input type="text" class="form-control " id="formahd" placeholder="@lang('project/ImportdataExcel/title.mahd')" name="mahd">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forsanphamcua">
                                    <span>@lang('project/ImportdataExcel/title.sanphamcua')</span>
                                </label>
                                <input type="text" class="form-control " id="forsanphamcua" placeholder="@lang('project/ImportdataExcel/title.sanphamcua')" name="sanphamcua">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fordvtn">
                            ...
                            <div class="form-group col-md-3">
                                <label for="fornamcg">
                                    <span>@lang('project/ImportdataExcel/title.namcg')</span>
                                </label>
                                <input type="number" class="form-control " id="fornamcg" placeholder="@lang('project/ImportdataExcel/title.namcg')" name="namcg">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forstcg">
                                    <span>@lang('project/ImportdataExcel/title.stcg')</span>
                                </label>
                                <input type="text" class="form-control " id="forstcg" placeholder="@lang('project/ImportdataExcel/title.stcg')" name="stcg">
                            </div>
                            <div class="form-group col-md-3">
...
<script>
    ...
    $('#import_unit').on('click', function () {
        ...
        $.ajax({
            url : "{!! route('admin.importdata.dtkhcn.importUnit') !!}",
            type : 'POST',
            data : formData,
            processData: false,  
            contentType: false,  
                ...
                var thead = `
                        <thead class="btn-success ">
                            <tr class="border ">
                                ...
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.sanphamcua')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.dvtn')
                                </th>
                                ...
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.stcg')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.trangthai')
                                </th>
    ...
    $("#import_unit_data").click(function() {
        if(checkEmpty() && checkWebsite() && checkEmail() && checkPhone()
            ...
            let loadData = "{{ route('admin.importdata.dtkhcn.importDataUnit') }}";
            fetch(loadData, {
                headers: {
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "{{ route('admin.importdata.dtkhcn.deleteUnit') }}" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id') 
        $("#id_unit").val(id);
        let loadData = "{{ route('admin.importdata.dtkhcn.dataUnit') }}" + "?id=" + id;
        fetch(loadData, {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then((response) => response.json())
            .then((data) => {
                $('#fortenhd').val(data.tenhd);
                $('#formahd').val(data.mahd);
                $('#forsanphamcua').val(data.sanphamcua);
                $('#fordvtn').val(data.dvtn);
                $('#fornamcg').val(data.namcg);
                $('#forstcg').val(data.stcg);
