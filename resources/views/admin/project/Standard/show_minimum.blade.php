...
{{-- Page title --}}
@section('title')
    @lang('project/Standard/title.qlmccc')
@parent
@stop
...
<section class="content-body">
    <div class="form-standard">
        ...
        <div class="container-fuild pl-5 pr-5">
            <div class="row">
                <div class="col-md-10">
                    <input type="text" placeholder="@lang('project/Standard/title.tmccc')" class="form-control " id="mctt_name">
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-4">
                ...
                <div class="col-md-1">
                    <button type="button" class="btn-benchmark mr-2 btn" data-toggle="modal" data-target="#modaleCreate" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Standard/title.tmmccco')">
                        <i class="bi bi-plus-square " style="font-size: 30px;color: #009ef7;"></i>
                    </button>
                </div>
                <div class="col-md-1">
                    <a href="{{ route('admin.thuongtruc.setstandard.exportMinimun') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Standard/title.xuat_excel')">
    ...
    <div class="form-standard">
        <h4>@lang('project/Standard/title.dsmccc')</h4>
        ...
        <div class="container-fuild">
            <table class="table table-striped table-bordered" id="table">
              <thead class="thead-light">
                <tr>
                    <th scope="col">
                        @lang('project/Standard/title.tdmccc')
                    </th>
                    <th scope="col">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modaleCreateLabal">
                    @lang('project/Standard/title.tmmccc')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('admin.thuongtruc.setstandard.createMctt') }}" method="post">
                @csrf
                <div class="modal-body">
                    <div class="container-fuild">
                        <div class="row">
                            <div class="col-md-6 pl-4 pr-4 pb-4">
                                <h4>
                                    @lang('project/Standard/title.mccc')
                                </h4>
                                ...
                                <div class="form-group">
                                    <label for="textcontent">
                                        @lang('project/Standard/title.content')
                                    </label>
                ...
                <div class="modal-footer-one" style="border-top: transparent;">
                    <button type="submit" class="btn btn-info" style="width: 6rem;">
                        @lang('project/Standard/title.luu') 
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    @lang('project/Standard/title.cnmccc')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('admin.thuongtruc.setstandard.updateMctt') }}" method="post">
                @csrf
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        ...
        table = $('#table').DataTable({
                ...
                searching: false,
                ajax:  {
                    url: "{!! route('admin.thuongtruc.setstandard.dataMinimum') !!}",
                    type: 'POST',
                    data: {
        ...
        $('#modalDelete').on('show.bs.modal', function (event) {
            ...
            var route = "{{ route('admin.thuongtruc.setstandard.deleteMctt') }}" + "?id_delete=" + id;
            var modal = $(this);
    ...
    <script type="text/javascript">
        ...
        $('#modalUpdate').on('show.bs.modal', function (event) {
            ...
            let routeApi = "{{ route('admin.thuongtruc.setstandard.loadDataMctt') }}" + "?mctt="  +  idmctt;
            fetch(routeApi, {
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
                ...
                .then((findMctt) => {
                    ...
                    let routeRe = "{{ route('admin.thuongtruc.setstandard.fStandardCriteria') }}" + "?btc="  +  findMctt.bo_tieuchuan_id + "&standard=true";
                ...
                .then((data) => {
                    ...
                    let routeRole_ = "{{ route('admin.thuongtruc.setstandard.loadTchiMctt') }}" + "?mctt="  +  idmctt;
