...
<html lang="en">
    ...
    <head><base href="">
        ...
        <!-- Hệ thống cũ -->
        <link rel="stylesheet" href="{{ asset('css/select2-4.1.0-rc.0/dist/css/select2.min.css') }}">
        ...
        <style>
            @font-face {
              ...
              src: url('{{ asset("font/Open_Sans/static/OpenSans/OpenSans-Medium.ttf")  }}');
            }
                ...
                <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                    ...
                    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                        ...
                        <a href="{{ route('admin.dashboard') }}">
                            <img alt="Logo" src="{{ asset('assets/media/logos/logo_uni2.png') }}" class="logo" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Aside toggler-->
                    ...
                    <!--end::Brand-->
                    <!--begin::Aside menu-->
                    @if(Request::is('admin/danh-gia-ngoai/bao-cao-tdg/bao-cao/*'))
                        @include('admin.layouts._left_menu_baocao')
                    @else
                                            ...
                                            <div class="sub-drop-icon menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px">
                                                ...
                                                <div class="menu-item px-3">
                                                    <div class="menu-content d-flex align-items-center px-3">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div class="fw-bolder d-flex align-items-center fs-5">{{ Sentinel::getUser()->name }}
                                                            </div>
                                                ...
                                                <!-- <div class="menu-item px-5">
                                                    <a href="{{ route('admin.users.edit', Sentinel::getUser()->id) }}" class="menu-link px-5">
                                                        <span class="menu-text">@lang('default.stk')</span>
                                                    </a>
                                                </div> -->
                                                <!--end::Menu item-->
                    ...
                    <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="" target="_blank" class="text-gray-800 text-hover-primary">@lang('default.kdcl')</a>
                            </div>
                            <!--end::Copyright-->
                            <!--begin::Menu-->
