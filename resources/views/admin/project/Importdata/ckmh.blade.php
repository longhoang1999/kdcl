...
{{-- Page title --}}
@section('title')
    @lang('project/ImportdataExcel/title.ckmh')
@parent
@stop
...
<section class="content-body">
    <div class="form-standard">
        <div class="item-group-button right-block mb-2">
            ...
            <a href="{{ route('admin.importdata.ckmh.exportCkmh') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Selfassessment/title.xuat_excel')">
                <i class="bi bi-file-earmark-excel " style="font-size: 35px;color: #50cd89;"></i>
            </a>
            <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="excel_import_monhoc" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    @lang('project/ImportdataExcel/title.cnckmh')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.importdata.ckmh.updateUnit') }}" method="post" id="update-unit">
                    @csrf
                    ...
                    <div class="container-fuild">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control " id="fortenmonhoc" placeholder="@lang('project/ImportdataExcel/title.tenmonhoc')" name="tenmonhoc">
                            </div>
                            <div class="form-group col-md-3" >
                                <label for="formdmh">
                                    <span>@lang('project/ImportdataExcel/title.mdmh')</span>
                                </label>
                                <input type="text" class="form-control " id="formdmh" placeholder="@lang('project/ImportdataExcel/title.mdmh')" name="mdmh">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="forsotinchi">
                                    <span>@lang('project/ImportdataExcel/title.sotinchi')</span>
                                </label>
                                <input type="number" class="form-control " id="forsotinchi" placeholder="@lang('project/ImportdataExcel/title.sotinchi')" name="sotinchi">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="forltgd">
                                    <span>@lang('project/ImportdataExcel/title.ltgd')</span>
                                </label>
                                <input type="text" class="form-control " id="forltgd" placeholder="@lang('project/ImportdataExcel/title.ltgd')" name="ltgd">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="forppdgsv">
                                    <span>@lang('project/ImportdataExcel/title.ppdgsv')</span>
                                </label>
                                <input type="text" class="form-control " id="forppdgsv" placeholder="@lang('project/ImportdataExcel/title.ppdgsv')" name="ppdgsv">
                            </div>
...
<script>
    ...
    $('#import_unit').on('click', function () {
        ...
        $.ajax({
            url : "{!! route('admin.importdata.ckmh.importUnit') !!}",
            type : 'POST',
            data : formData,
            processData: false,  
            contentType: false,  
    ...
    $("#import_unit_data").click(function() {
        if(checkEmpty() && checkWebsite() && checkEmail() && checkPhone()
            ...
            let loadData = "{{ route('admin.importdata.ckmh.importDataUnit') }}";
            fetch(loadData, {
                headers: {
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "{{ route('admin.importdata.ckmh.deleteUnit') }}" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id') 
        $("#id_unit").val(id);
        let loadData = "{{ route('admin.importdata.ckmh.dataUnit') }}" + "?id=" + id;
        fetch(loadData, {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then((data) => {
                ...
                $("#forltgd").val(data.lich_day);
                $("#forppdgsv").val(data.ppdgsv);
