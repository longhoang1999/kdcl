    ...
    <div class="form-standard">
        <div class="item-group-button space-block mb-2">
            ...
            <div class="space-block-item">
                ...
                <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="excel_import_tinh_trang_tn" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <div class="table-show">
            <table class="table table-striped table-bordered" id="table" width="100%"   >
              <thead>
                <tr>
                  <th scope="col">
                      @lang('project/ImportdataExcel/title.tccha')
                  </th>
                  <th scope="col">
                      @lang('project/ImportdataExcel/title.tccon')
                  </th>
                  <th scope="col">
                      @lang('project/ImportdataExcel/title.nam')
                  </th>
                  <th scope="col">
                      @lang('project/ImportdataExcel/title.giatri')
                  </th>
                  <th scope="col">
              ...
              <tbody>
                @foreach($tttnsv as $value)
                 @php
                    $childs  = DB::table("excel_import_tinh_trang_tn")
    ...
    <div class="modal-dialog modal-xl ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="css_table" method="post" action="{{ route('admin.importdata.tttn.importUnit') }}">
                    @csrf
                    <div class="container-fuild">
                        ...
                        <div class="block-code">
                            <div class="row">
                                <div class="col-md-7">
                                    <label>
                                        @lang('project/ImportdataExcel/title.dgsvtn')
                                    </label>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="block-child">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsv')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsvtl')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name3_2">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-7">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsctlk')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name3_3">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block-code">
                            <div class="row">
                                <div class="col-md-8">
                                    <label>
                                        @lang('project/ImportdataExcel/title.svcvl')
                                    </label>
                                </div>
                                <div class="col-md-2">
                                    <input type="checkbox" class="checkbox-parent">
                            ...
                            <div class="block-child">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsvcvl')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name4_1_1">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsvcvl2')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name4_1_2">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.svtndt')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name4_2">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tltvl')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="text" name="name4_3"> 
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                        ...
                        <div class="block-code">
                            <div class="row">
                                <div class="col-md-8">
                                    <label>
                                        @lang('project/ImportdataExcel/title.dgnsd')
                                    </label>
                                </div>
                                <div class="col-md-2">
                                    <input type="checkbox" class="checkbox-parent">
                            ...
                            <div class="block-child">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.duyccv')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.yccvcdt')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>
                                            @lang('project/ImportdataExcel/title.tlsvdtl')
                                        </label>
                                    </div>
                                    <div class="col-md-1">
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="modalDeleteLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.importdata.tttn.deleteUnit') }}" method="post">
                @csrf
...
<div class="modal fade" id="modalUpdate" tabindex="-1" role="dialog" aria-labelledby="modalUpdateLabel" aria-hidden="true">
  <div class="modal-dialog modal-ml">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.importdata.tttn.updateUnit') }}" method="post">
            @csrf
...
<script>
    ...
    $(".btn-update").click(function() {
        $(".tieu_chi_con").text(
            "@lang('project/ImportdataExcel/title.tccon'): " + $(this).parent().parent().find(".tc_content").text()
        );
        $(".tieu_chi_nam").text(
