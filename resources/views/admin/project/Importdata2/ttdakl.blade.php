...
{{-- Page title --}}
@section('title')
    @lang('project/ImportdataExcel/title.ttdakl')
@parent
@stop
...
<section class="content-body">
    <div class="form-standard">
        <div class="item-group-button right-block mb-2">
            ...
            <a href="{{ route('admin.importdata.ttdakl.exportTtdakl') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Selfassessment/title.xuat_excel')">
                <i class="bi bi-file-earmark-excel " style="font-size: 35px;color: #50cd89;"></i>
            </a>
            <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="excel_import_doan_khoaluan" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    @lang('project/ImportdataExcel/title.cnttdakl')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.importdata.ttdakl.updateUnit') }}" method="post" id="update-unit">
                    @csrf
                    ...
                    <div class="container-fuild">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control " id="fortendetai" placeholder="@lang('project/ImportdataExcel/title.tendetai')" name="tendetai">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forhvtnth">
                                    <span>@lang('project/ImportdataExcel/title.hvtnth')</span>
                                </label>
                                <input type="text" class="form-control " id="forhvtnth" placeholder="@lang('project/ImportdataExcel/title.hvtnth')" name="hvtnth">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forhvtnhd">
                                    <span>@lang('project/ImportdataExcel/title.hvtnhd')</span>
                                </label>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control " id="forndtt" placeholder="@lang('project/ImportdataExcel/title.ndtt')" name="ndtt">
                            </div>
...
<script>
    ...
    $('#import_unit').on('click', function () {
        ...
        $.ajax({
            url : "{!! route('admin.importdata.ttdakl.importUnit') !!}",
            type : 'POST',
            data : formData,
            processData: false,  
            contentType: false,  
    ...
    $("#import_unit_data").click(function() {
        if(checkEmpty() && checkWebsite() && checkEmail() && checkPhone()
            ...
            let loadData = "{{ route('admin.importdata.ttdakl.importDataUnit') }}";
            fetch(loadData, {
                headers: {
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "{{ route('admin.importdata.ttdakl.deleteUnit') }}" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id') 
        $("#id_unit").val(id);
        let loadData = "{{ route('admin.importdata.ttdakl.dataUnit') }}" + "?id=" + id;
        fetch(loadData, {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then((data) => {
                ...
                $("#forhvtnhd").val(data.htnhd);
                $("#forndtt").val(data.ndtt);
