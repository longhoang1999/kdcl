        ...
        <style>
      	...
      	<div class="m-t-md">
		    ...
		    <form action="{{route('admin.tudanhgia.database.save_file_ctdt')}}" method="POST" enctype="multipart/form-data">
			    ...
			    <div>
			  	...
			  	<div>
				    ...
				    <span class="edit_input">{{ $dulieu->p27_caodang }}</span>
				</div>
				<div>
				    <span>Số lượng chuyên ngành đào tạo Đại học :</span>
				    <span class="edit_input">{{ $dulieu->p27_daihoc }}</span>
				</div>
				<div>
				    <span>Số lượng chuyên ngành đào tạo Thạc sĩ :</span>
				    <span class="edit_input">{{ $dulieu->p27_thacsi }}</span>
				</div>
				<div>
				    <span>Số lượng chuyên ngành đào tạo Tiến sĩ :</span>
				    <span class="edit_input">{{ $dulieu->p27_tiensi }}</span>
				</div>
				...
				<p>
				    <i><strong>@lang('project/Externalreview/title.28')</strong></i>
				</p>
			    ...
			    <p><i><strong>@lang('project/Externalreview/title.29')<b>
			    	<span class="edit_input">{{ $dulieu->p29_tongnganhdt }}</span>
			    </b></strong></i></p>
			    ...
			    <p>Tổng số giảng viên cơ hữu :
				    <span class="edit_input">{{ $dulieu->p31_tongvcohuu }}</span>
				</p>
				<p>@lang('project/Externalreview/title.tile')
				    <span class="edit_input">{{ $dulieu->p31_tylegvch }}</span>
				</p>
				...
				<p>@lang('project/Externalreview/title.33cham1')
				    <span class="edit_input">{{ $dulieu->p33_1_tuoitb }}</span>
				</p>
				<p>@lang('project/Externalreview/title.33cham2')
				    <span class="edit_input">{{ $dulieu->p33_2_tdts }}</span>
				</p>
				<p>@lang('project/Externalreview/title.33cham3')
				    <span class="edit_input">{{ $dulieu->p33_3_tdths }}</span>
				</p>
		        ...
		        <div>
		        	...
		        	<span class="edit_input">{{$dulieu->p45_tysosach}}</span>
		        </div>
	        ...
	        <div>
	        	<span>Tỷ số sách đã được xuất bản (quy đổi) trên cán bộ cơ hữu: </span>
	        	<span class="edit_input">
	        		{{$dulieu->viii_6_tssddsb}}
	        	</span>
	        </div>
	        <div>
	        	<span>Tỷ số bài đăng tạp chí (quy đổi) trên cán bộ cơ hữu: </span>
	        	<span class="edit_input">
	        		{{$dulieu->viii_6_tsbdtc}}
	        	</span>
	        </div>
	        <div>
	        	<span>Tỷ số bài báo cáo (quy đổi) trên cán bộ cơ hữu: </span>
	        	<span class="edit_input">
	        		{{$dulieu->viii_6_tsbdbc}}
	        	</span>
	        </div>
	        <p><i><strong>
	        	7. Cơ sở vật chất:
