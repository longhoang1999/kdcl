...
@section('title')
    @lang('project/Externalreview/title.dugiott')
@parent
@stop
...
<script>
  ...
  {{--  $('select[name=ds_bao_cao]').on("change", function () {
        window.location = "{{ route('admin.danhgiangoai.baocaotudanhgia.index) }}/" + $(this).val();
    });--}}
</script>
@stop