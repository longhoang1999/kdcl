...
<section class="content-body">
    <div class="form-standard">
        <div class="item-group-button right-block mb-2">
            ...
            <a href="{{ route('admin.importdata.ctdt.exportCtdt') }}" class="btn btn-benchmark mr-2" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/Selfassessment/title.xuat_excel')">
                <i class="bi bi-file-earmark-excel " style="font-size: 35px;color: #50cd89;"></i>
            </a>
            <button class="btn" data-toggle="modal" data-target="#modalDeleteAll__" data-nametable="export_import_ctdt" data-bs-toggle="tooltip" data-bs-placement="top" title="@lang('project/ImportdataExcel/title.xoatatca')">
        ...
        <table class="table table-striped table-bordered" id="table" width="100%">
            <thead>
             <tr>
                ...
                <th>
                    @lang('project/ImportdataExcel/title.cndt')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.manganh')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.tenctdt')
                </th>
                <th>
                    @lang('project/ImportdataExcel/title.nambddt')
                </th>
                <th>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalUpdateLabel">
                    @lang('project/ImportdataExcel/title.cnccdt')
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.importdata.ctdt.updateUnit') }}" method="post" id="update-unit">
                    @csrf
                    ...
                    <div class="container-fuild">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="forkhoabm">
                                    <span>@lang('project/ImportdataExcel/title.khoabm')</span>
                                </label>
                                <input type="text" class="form-control " id="forkhoabm" placeholder="@lang('project/ImportdataExcel/title.khoabm')" name="khoabm">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forcndt">
                                    <span>@lang('project/ImportdataExcel/title.cndt')</span>
                                </label>
                                <input type="text" class="form-control " id="forcndt" placeholder="@lang('project/ImportdataExcel/title.cndt')" name="cndt">
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                <label for="fortlct">
                                    <span>@lang('project/ImportdataExcel/title.tenctdt')</span>
                                </label>
                                <input type="text" class="form-control " id="fortenctdt" placeholder="@lang('project/ImportdataExcel/title.tenctdt')" name="tenctdt">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forlhdt">
                                    <span>@lang('project/ImportdataExcel/title.lhdt')</span>
                                </label>
                                <input type="text" class="form-control " id="forlhdt" placeholder="@lang('project/ImportdataExcel/title.lhdt')" name="lhdt">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fornambddt">
                                    <span>@lang('project/ImportdataExcel/title.nambddt')</span>
                                </label>
                                <input type="number" class="form-control " id="fornambddt" placeholder="@lang('project/ImportdataExcel/title.nambddt')" name="nambddt">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forddtcdt">
                                    <span>@lang('project/ImportdataExcel/title.ddtcdt')</span>
                                </label>
                                <input type="text" class="form-control " id="forddtcdt" placeholder="@lang('project/ImportdataExcel/title.ddtcdt')" name="ddtcdt">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forslsv">
                                    <span>@lang('project/ImportdataExcel/title.slsv')</span>
                                </label>
                                <input type="number" class="form-control " id="forslsv" placeholder="@lang('project/ImportdataExcel/title.slsv')" name="slsv">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forslsvtn">
                                    <span>@lang('project/ImportdataExcel/title.slsvtn')</span>
                                </label>
                                <input type="number" class="form-control " id="forslsvtn" placeholder="@lang('project/ImportdataExcel/title.slsvtn')" name="slsvtn">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fortenvb">
                                    <span>@lang('project/ImportdataExcel/title.tenvb')</span>
                                </label>
                                <input type="text" class="form-control " id="fortenvb" placeholder="@lang('project/ImportdataExcel/title.tenvb')" name="tenvb">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="fortddt">
                            ...
                            <div class="form-group col-md-3">
                                <label for="fortgdtc">
                                    <span>@lang('project/ImportdataExcel/title.tgdtc')</span>
                                </label>
                                <input type="text" class="form-control " id="fortgdtc" placeholder="@lang('project/ImportdataExcel/title.tgdtc')" name="tgdtc">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="forcttshn">
                                    <span>@lang('project/ImportdataExcel/title.cttshn')</span>
                                </label>
                                <input type="text" class="form-control " id="forcttshn" placeholder="@lang('project/ImportdataExcel/title.cttshn')" name="cttshn">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="formkndt">
                                    <span>@lang('project/ImportdataExcel/title.mkndt')</span>
                                </label>
                                <input type="text" class="form-control " id="formkndt" placeholder="@lang('project/ImportdataExcel/title.mkndt')" name="mkndt">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="formlvdt">
                                    <span>@lang('project/ImportdataExcel/title.mlvdt')</span>
                                </label>
                                <input type="text" class="form-control " id="formlvdt" placeholder="@lang('project/ImportdataExcel/title.mlvdt')" name="mlvdt">
                            </div>
                        </div>
...
<script>
    ...
    $('#import_unit').on('click', function () {
        ...
        $.ajax({
            url : "{!! route('admin.importdata.ctdt.importUnit') !!}",
            type : 'POST',
            data : formData,
            processData: false,  
            contentType: false,  
                ...
                var thead = `
                        <thead class="btn-success ">
                            <tr class="border ">
                                ...
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.lhdt')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.nambddt')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.ddtcdt')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.slsv')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.slsvtn')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.tenvb')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.tddt')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.tgdtc')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.cttshn')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.mkndt')
                                </th>
                                <th class="row_width p-2">
                                    @lang('project/ImportdataExcel/title.mlvdt')
                                </th>
                                <th class="row_width p-2">
        ...
        if(checkEmpty() && checkWebsite() && checkEmail() && checkPhone()
            ...
            $(".row_number").each(function( index ) {
                let dataObj = {
                    ...
                    'khoabm' :   $(this).find('.row1').text().trim(),
                    'cndt' :  $(this).find('.row2').text().trim(),
                    'manganh' :   $(this).find('.row3').text().trim(),
                    'tenctdt' :  $(this).find('.row4').text().trim(),
                    'lhdt' :  $(this).find('.row5').text().trim(),
                    'nambddt' : $(this).find('.row6').text().trim(),
                    'ddtcdt' :   $(this).find('.row7').text().trim(),
                    'slsv' :   $(this).find('.row8').text().trim(),
                    'slsvtn' :   $(this).find('.row9').text().trim(),
                    'tenvb' :   $(this).find('.row10').text().trim(),
                    'tddt' :   $(this).find('.row11').text().trim(),
                    'tgdtc' :   $(this).find('.row12').text().trim(),
                    'cttshn' :   $(this).find('.row13').text().trim(),
                    'mkndt' :   $(this).find('.row14').text().trim(),
                    'mlvdt' :   $(this).find('.row15').text().trim(),
                    
                }
                dataSubmit.push(dataObj);
            });

            let loadData = "{{ route('admin.importdata.ctdt.importDataUnit') }}";
            fetch(loadData, {
                headers: {
    ...
    $('#modalDelete').on('show.bs.modal', function (event) {
        ...
        var route = "{{ route('admin.importdata.ctdt.deleteUnit') }}" + "?id_delete=" + id;
        var modal = $(this);
    ...
    $('#modalUpdate').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id') 
        $("#id_unit").val(id);
        let loadData = "{{ route('admin.importdata.ctdt.dataUnit') }}" + "?id=" + id;
        fetch(loadData, {
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
            ...
            .then((response) => response.json())
            .then((data) => {
                $("#forkhoabm").val(data.khoa_BM);
                $("#forcndt").val(data.cndt);
                $("#formanganh").val(data.ma_nganh);
                $("#fortenctdt").val(data.ten_ctdt);
                $("#forlhdt").val(data.lhdt);
                $("#fornambddt").val(data.nam_bddt);
                $("#forddtcdt").val(data.diadiem_tochuc);
                $("#forslsvtn").val(data.sl_svtn);
                $("#forslsv").val(data.slsv);
                $("#fortenvb").val(data.ten_vanbang);
                $("#fortddt").val(data.tddt);
                $("#fortgdtc").val(data.tgdtc);
                $("#forcttshn").val(data.cttshn);
                $("#formkndt").val(data.mkndt);
                $("#formlvdt").val(data.mlvdt);
            })
    })
