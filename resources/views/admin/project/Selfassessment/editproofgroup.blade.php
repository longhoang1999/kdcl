...
{{-- Page title --}}
@section('title')
    @lang('project/Selfassessment/title.cnmc')
@parent
@stop
...
<div class="block-flex">
    <section class="content-body">
        <div class="block-item">
            <h2>@lang('project/Selfassessment/title.cnmc')</h2>
            <div class="form-block">
                        ...
                        @foreach($listTChi as $tchi)
                            <option
                                @if($tchi->id == $tieuchi->id)
                                    selected
                                @endif
                             value="{{ $tchi->id }}">TC {{ $tchi->sttTC }}.{{ $tchi->stt }}: {{ $tchi->mo_ta }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="block-group">
                        ...
                        @foreach($listMCTT as $mctt)
                            <option
                                @if(in_array($mctt->id, $listminhchungtoithieu))
                                    selected
                                @endif
                             value="{{ $mctt->id }}">{{ $mctt->tieu_de }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="block-group">
                ...
                <div class="block-group">
                    ...
                    <input type="text" placeholder="@lang('project/Selfassessment/title.tmc')" class="form-control" id="name_minhchung" value="{{ $mcgop->tieu_de }}">
                </div>
                <div class="block-group">
                    <label for="trichyeu_mc">@lang('project/Selfassessment/title.trichyeu')</label>
                    <textarea class="form-control" placeholder="@lang('project/Selfassessment/title.tymc')" id="trichyeu_mc">{{ $mcgop->trich_yeu }}</textarea>
                </div>
                <div class="block-group">
