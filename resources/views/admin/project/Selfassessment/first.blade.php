...
<section class="content-body">
    ...
    <div class="body_content">
        ...
        @include("admin.project.Selfassessment.viewcomment",([ 'kieu' => 'chung.modau', 'text' => $text, 'id' => $id, 'id_kehoacchung' => $id_kehoacchung]))
                ...
                <form class="ajaxForm form-horizontal reloadDone" id="nhanXetForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="nhanxet" id="id_nhanxet" class="form-control"></textarea>
                            </div>
                        </div>
 ...
 <!-- Bootstrap WYSIHTML5 -->
    ...
    <script>
        ...
        function writecomment(){
            ...
            var text = $('#id_nhanxet').val();
            console.log(text);
            if( text != '' ){ 
                $.ajax({
                    url: "{{ route('admin.tudanhgia.commentreport.createComment') }}",
                    type: 'POST',
                    data:{
                        id_khbc: "{{$id}}",
                        text: text,
