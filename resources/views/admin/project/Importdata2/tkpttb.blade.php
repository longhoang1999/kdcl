    ...
    <div class="form-standard">
        ...
        <div class="card mt-4">
    		<div class="card-body">
                ...
                <hr>
                <form class="row" action="{{ route('admin.importdata2.tkpttb.addfilenew') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-4">
...
<script>
    ...
    $("#selectYear").on("change", function() {
        if($(this).val() == ""){
            ...
            let routeApi = "{{ route('admin.importdata2.tkpttb.showFileData') }}";
            fetch(routeApi, {
                headers: {
